			...
			public void onClick(View v) {
				...
				new Thread() {
					...
					public void run() {
						...
						String jenkinsURL = editTextJenkinsURL.toString();
						String userName = editTextUserName.toString();
						String password = editTextPassword.toString();
						
						try {
//							HttpClient httpClient = JenkinsUtil.login(jenkinsURL, userName, password);
							Thread.sleep(10000);
...
//		ad.setTitle("账号登陆");
//		ad.setView(findViewById(R.layout.login_view));
